...
function Table({ data, admin, onDeleteHandler, downloadVideo, progress }) {
  return (
    <div className="overflow-x-auto overflow-hidden relative w-full scrollbar-custom">
      <table className="min-w-[600px] w-full table-auto border border-border divide-y divide-border">
        <thead>
